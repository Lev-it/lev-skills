...
description: Production-ready CSS transitions for web apps. Use proactively whenever designing or building UI components — modals, dropdowns, notifications, cards, page layouts, forms, dashboards, or any interactive element. Automatically apply when the user says "design a UI", "build a component", "create a page", "add a button", "build a form", "design a dashboard", or any UI/frontend task. Also triggers on "add a transition", "animate the dropdown", "make the modal open smoothly", "swap icon", "page slide", "stagger animation", "open / close transition", "make it animate", "tween the size", "fade between", "smooth open", "smooth close".
---
